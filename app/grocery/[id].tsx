        ...
        {uncheckedItems.length > 0 && (
          <View className="p-4">
            ...
            {uncheckedItems.map((item) => (
              <View
                key={item.id}
                className="flex-row items-center bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mb-2"
              >
                <TouchableOpacity
                  className="mr-3"
        ...
        {checkedItems.length > 0 && (
          <View className="p-4">
            ...
            {checkedItems.map((item) => (
              <View
                key={item.id}
                className="flex-row items-center bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mb-2 opacity-50"
              >
                <TouchableOpacity
                  className="mr-3"
                  onPress={() => handleToggleItem(item.id)}
                >
                  <View className="w-6 h-6 bg-green-600 rounded items-center justify-center">
                    <FontAwesome name="check" size={14} color="white" />
                  </View>
                </TouchableOpacity>
                <View className="flex-1">
                  <Text className="text-gray-900 dark:text-white font-medium line-through">
                    {item.name}
                  </Text>
                  <Text className="text-sm text-gray-500 dark:text-gray-400">
                    {item.quantity} {item.unit}
